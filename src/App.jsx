...
import Page3 from './pages/F3'
import Page4 from './pages/F4'
import Page5 from './pages/F6'
import Page6 from './pages/F6'
import Page7 from './pages/F6'
import Page8 from './pages/F7'
import Page9 from './pages/F7'
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <main>
        ...
        <Route path="/f3" element={<Page3 />} />
        <Route path="/f4" element={<Page4 />} />
        <Route path="/f6" element={<Page5 />} />
        <Route path="/f6" element={<Page6 />} />
        <Route path="/f6" element={<Page7 />} />
        <Route path="/f7" element={<Page8 />} />
        <Route path="/f7" element={<Page9 />} />
        </Routes>
      </main>
    </div>
  )
